...
public class HotelController {
    ...
    @PostMapping("/invoice")
    public ResponseEntity<?> createInvoice(@RequestBody HotelController.InvoiceRequest request) {
        try {
            Long invoiceId = hotelService.produceInvoice(
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(new HotelController.InvoiceResponse(
    ...
    public static class InvoiceResponse {
        ...
        public InvoiceResponse(String message, Long invoiceId) {
            this.message = message;
