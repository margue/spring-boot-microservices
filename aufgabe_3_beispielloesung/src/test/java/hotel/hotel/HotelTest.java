...
class HotelTest {
    ...
    @MockitoBean
    private InvoiceServiceApi invoiceService;
    ...
    public void produceInvoice_noPayment() {
        ...
        // WHEN
        HotelController.InvoiceRequest request = new HotelController.InvoiceRequest(customer1, endDate, roomNumbers);
    ...
    public void produceInvoice_paymentInsufficient() {
        ...
        // WHEN
        HotelController.InvoiceRequest invoiceRequest = new HotelController.InvoiceRequest(customer1, endDate, roomNumbers);
    ...
    public void produceInvoice_oneRoomOneNight_withOldBooking() {
        ...
        Assertions.assertThat(response.getBody()).isInstanceOf(HotelController.InvoiceResponse.class);
        HotelController.InvoiceResponse invoiceResponse = (HotelController.InvoiceResponse) response.getBody();
        Assertions.assertThat(invoiceResponse.getInvoiceId()).isNotNull();
    }
