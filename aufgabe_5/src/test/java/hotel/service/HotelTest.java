...
import hotel.controller.HotelController.CheckInRequest;
import hotel.controller.HotelController.CheckOutRequest;
import hotel.controller.HotelController.RoomBookingRequest;
...
class HotelTest {
    ...
    void checkOut_roomWasInvoiced() {
        ...
        Assertions.assertThat(roomRepository.findByRoomNumber("1").getBookings().getFirst().getInvoice()).isNotNull();
    }
}
