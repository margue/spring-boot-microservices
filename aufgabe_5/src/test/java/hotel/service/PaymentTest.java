...
import hotel.controller.ErrorResponse;
import hotel.controller.PaymentController;
import hotel.controller.PaymentController.InvoiceRequest;
import hotel.controller.PaymentController.PaymentRequest;
...
class PaymentTest {
    ...
    void clearRepositories() {
        ...
        allRooms.forEach(room ->
                room.getBookings().forEach(bookingInterval ->
                        bookingInterval.setInvoice(null)));
    ...
    public void markBookingsAsInvoiced_oneBooking() {
        ...
        Assertions.assertThat(roomRepository.findAllBookingIntervalsByCustomerName(customer1))
                .extracting(BookingInterval::getInvoice).doesNotContainNull();
    }
    ...
    public void markBookingsAsInvoiced_twoBookingsOneInPast() {
        ...
        Assertions.assertThat(bookingIntervals.get(0).getInvoice()).isNotNull();
        Assertions.assertThat(bookingIntervals.get(1).getInvoice()).isNull();
    }
}
